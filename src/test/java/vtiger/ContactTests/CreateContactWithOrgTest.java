...
WebDriver driver;
		...
		//STEP4: NAVIGATE TO CONTACT
		driver.findElement(By.xpath("(//a[text()='Contacts'])[1]")).click();
		
		//STEP5: NAVIGATE TO CREATE CONTACT
		driver.findElement(By.xpath("//img[@alt='Create Contact...']")).click();
		//STEP6: FILL MANDATORY FIELDS AND CHOOSE ORG NAME
		...
		Set<String> windows = driver.getWindowHandles();
	 	...
	 	driver.findElement(By.xpath("//a[text()='Infosys85']")).click();
